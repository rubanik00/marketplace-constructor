...
abstract contract ERC1155MintableRoyaltyUpgradeable is
    ...
    ERC1155Signature
{
    ...
    function __ERC1155RoyaltyUpgradeable_init(
        string memory _name,
        string memory _symbol,
        string memory _version,
        string memory _uri
    ) internal onlyInitializing {
        __ERC1155RoyaltyUpgradeable_init_unchained(
            _name,
            _symbol,
            _version,
            _uri
    ...
    function __ERC1155RoyaltyUpgradeable_init_unchained(
        string memory _name,
        string memory _symbol,
        string memory _version,
        string memory _uri
