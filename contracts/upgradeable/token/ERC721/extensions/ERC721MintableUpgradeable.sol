...
contract ERC721MintableUpgradeable is
    ERC721Upgradeable,
    ...
    ERC721Signature
{
    ...
    function __ERC721MintableUpgradeable_init(
        string memory _name,
        string memory _symbol,
        string memory _version
    ) internal onlyInitializing {
        __ERC721MintableUpgradeable_init_unchained(_name, _symbol, _version);
    }

    function __ERC721MintableUpgradeable_init_unchained(
        string memory _name,
        string memory _symbol,
        string memory _version
    ) internal onlyInitializing {
    ...
    function mint(
        ...
        require(
            hasRole(
                SIGNER_ERC721_ROLE,
                _getSigner(nonce, msg.sender, uri, v, r, s)
            ),
